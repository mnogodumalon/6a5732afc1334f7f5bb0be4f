...
// <custom:intent-imports>
import { IconCalendarPlus, IconStar } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/sitzung-planen', label: 'Sitzung planen', icon: IconCalendarPlus, description: 'Format wählen, Sitzung konfigurieren und Teilnehmer einladen' },
  { path: '/intents/bewertungsrunde', label: 'Bewertungsrunde', icon: IconStar, description: 'Feedback aller Teilnehmer einer Sitzung erfassen' },
  // </custom:intents>
];
