...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['titel', 'erfahrungsraum', 'datum_uhrzeit', { row: ['moderator_vorname', 'moderator_nachname'], cols: '1fr 1fr' }, 'teilnehmer', 'ort_bezeichnung', { row: ['strasse', 'hausnummer'], cols: '2fr 1fr' }, { row: ['postleitzahl', 'stadt'], cols: '1fr 2fr' }, 'agenda', 'nachbereitungsnotizen'],
  defaults: {
