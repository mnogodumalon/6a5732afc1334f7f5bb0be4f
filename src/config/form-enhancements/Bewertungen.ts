// Auto-generated. Per-entity form-enhancements config for "Bewertungen".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['sitzung', 'teilnehmer', 'bewertungsdatum', 'gesamteindruck', 'relevanz', 'umsetzbarkeit', 'methodenqualitaet', 'wichtigste_erkenntnis', 'naechste_schritte', 'verbesserungsvorschlaege', 'weiterempfehlung'],
  defaults: {
    'bewertungsdatum': { kind: 'today' },
    'weiterempfehlung': { kind: 'literal', value: true },
  },
  computed: {},
};
