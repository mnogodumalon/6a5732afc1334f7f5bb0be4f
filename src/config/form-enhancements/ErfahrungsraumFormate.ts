// Auto-generated. Per-entity form-enhancements config for "Erfahrungsraum-Formate".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['name', 'beschreibung', 'zielsetzung', 'zielgruppe', 'methodik', 'weitere_methoden', { row: ['dauer_stunden', 'max_teilnehmer'], cols: '1fr 1fr' }, 'status', 'anmerkungen'],
  defaults: {
