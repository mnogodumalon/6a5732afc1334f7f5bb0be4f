...
export function TeilnehmerDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: TeilnehmerDialogProps) {
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'organisation': (
      <div key="organisation" className="space-y-1.5">
        ...
        <Input
          id="organisation"
          placeholder="z. B. Universität Köln"
    ...
    'rolle': (
      <div key="rolle" className="space-y-1.5">
        <Label htmlFor="rolle">Rolle / Position</Label>
        <Input
          id="rolle"
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Besonderheiten, Kontaktvorlieben..."
  ...
  const FIELD_LABELS: Record<string, string> = {"vorname": "Vorname", "nachname": "Nachname", "organisation": "Organisation", "rolle": "Rolle / Position", "email": "E-Mail-Adresse", "telefon": "Telefonnummer", "notizen": "Notizen"};
